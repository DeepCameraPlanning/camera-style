...
def parse_arguments() -> str:
    ...
    return args.raw_dir, args.flow_dir, args.reverse, args.speedup


if __name__ == "__main__":
    raw_dir, flow_dir, reverse, speedup = parse_arguments()
    ...
    if reverse:
        for clip_dirname in tqdm(os.listdir(raw_dir)):
            ...
            reversed_raw_dir = osp.join(raw_dir, "reversed_" + clip_dirname)
    ...
    if speedup:
        for clip_dirname in tqdm(os.listdir(raw_dir)):
            speedup_raw_dir = osp.join(raw_dir, "speedup_" + clip_dirname)
